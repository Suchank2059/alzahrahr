    ...
    <footer class="footer pt-12 xl:pt-[50px] mt-auto">
        <div class="container mx-auto flex flex-wrap justify-between">
            <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 mb-6">
                ...
                <p><i class="fa fa-map-marker mr-2"></i>123 Main Street</p>
            ...
            <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 mb-6">
                ...
                <p><i class="fa fa-envelope mr-2"></i>Email: info@example.com</p>
                <p><i class="fa fa-phone mr-2"></i>Phone: (123) 456-7890</p>
            </div>
            <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 mb-6">
