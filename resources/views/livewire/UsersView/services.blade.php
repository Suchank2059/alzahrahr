<div class="h-screen w-screen bg-gray-200 ">
  ...
  <!--====== SERVICES PART START ======-->
  <div class="-400 mt-32 md:px-10 px-4 py-12 font-[sans-serif]">
    <div class="max-md:max-w-lg mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-gradient-to-b  rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300">
