...
<div class="font-[sans-serif] text-[#333]">
      <div class="max-w-5xl mx-auto">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <p class="text-sm mt-4 leading-relaxed">Veniam proident aute magna anim excepteur et ex consectetur velit ullamco veniam minim aute sit. Ullamco nisi enim ipsum irure laboris ad ut. Esse cupidatat deserunt magna aute.</p>
        </div>
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-x-8 gap-y-10 max-md:justify-center mt-12">
          <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
            <img src="https://readymadeui.com/team-1.webp" class="w-full h-60 object-contain object-top bg-gray-300" />
            <div class="p-4">
          ...
          <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
            <img src="https://readymadeui.com/team-2.webp" class="w-full h-60 object-contain object-top bg-gray-300" />
            <div class="p-4">
          ...
          <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
            <img src="https://readymadeui.com/team-3.webp" class="w-full h-60 object-contain object-top bg-gray-300" />
            <div class="p-4">
