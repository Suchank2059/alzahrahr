                ...
                <div class="carousel-item relative flex items-center">
                  <div class="absolute inset-0 flex items-center justify-center text-accent p-4">
                    <div class="text-center">
                     <h2 class="text-2xl font-bold text-accent mb-4">Your Text Goes Here</h2>
                     <a href="#_" class="relative px-5 py-2 mr-4 font-medium text-white group">
                        ...
                        <span class="relative animate-bounce animate-duration-[10ms] animate-delay-[5ms]">Button Text</span>
                    </a>
    ...
    <div class="container flex justify-center items-center px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
            <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">Khshitij Dhungana</h1>

                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Chairman</p>
                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">mlakdgnl'asdfa asdf;na;ndf f asdnf'asdkf k dsaknf;kasdfj fjndsakjfo asdfjiasdjf asfdja sdfjasiodjf aisdhfasd fhasdfhas dfhaspdfhasdfashdf</p>
            ...
            <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                ...
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">Alzahara Dubai</h1>

                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Post</p>
                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">mlakdgnl'asdfa asdf;na;ndf f asdnf'asdkf k dsaknf;kasdfj fjndsakjfo asdfjiasdjf asfdja sdfjasiodjf aisdhfasd fhasdfhas dfhaspdfhasdfashdf</p>
...
<div class = "containers flex">
    <div class = "card relative max-w-300 h-215 bg-white m-30 mx-10 p-20 pb-15 flex flex-col shadow-md transition-transform duration-300 ease-in-out rounded-15 hover:h-[320px]">
      ...
      <div class = "content relative top-neg-140 pt-32 text-center text-black visibility-hidden opacity-0 transition-opacity duration-300 ease-in-out">
        ...
        <p class="leading-4 text-[10px]">DIn publishing and graphic design,Lorem ipsum is a placeholder textcommonly used to demonstrate the visual  form of a document or a typeface without         relying on meaningful content.</p>
      </div>
    </div>
    <div class = "card relative max-w-300 h-215 bg-white m-30 mx-10 p-20 pb-15 flex flex-col shadow-md transition-transform duration-300 ease-in-out rounded-15 hover:h-[320px]">
      <div class = "image relative w-260 h-260 top-neg-40 left-8 shadow-md z-10">
...
<section class="our-team py-32 text-center bg-grey">
    ...
    <button class="h-4 w-6 p-4 rounded-xl bg-red-700  placeholder:More "></button>
  </section>
    ...
    function showSlide(n) {
        ...
        slides.forEach((slide, index) => {
            if (index === currentSlide) {
                ...
                slide.classList.add('animate__animated', 'animate__slideInRight'); // Add fadeIn animation
            } else {
                slide.style.display = 'none';
                slide.classList.remove('animate__animated', 'animate__slideInLeft'); // Remove animation from other slides
            }
        });
    }
...
<script>//#region - start of - number counter animation
