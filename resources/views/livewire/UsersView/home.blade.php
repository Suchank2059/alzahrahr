<div>
            ...
            <div class="carousel" id="myCarousel">
                <div class="carousel-inner">
                    <div class="carousel-item relative flex items-center">
                        <div class="absolute inset-0 flex items-center justify-center text-accent p-4 bg-slate-500 bg-opacity-60">
                            <div class="text-center">
                                <h2 class="text-4xl font-bold text-emerald-200 animate-bounce animate-duration-10 animate-delay-5 mb-4">
                                    Alzahra Human Resource Consultancy Welcomes You</h2>
                                <button class="relative px-5 py-2 mr-4 font-medium text-white group bg-purple-700 hover:bg-purple-500">
                                    <span class="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform translate-x-0 -skew-x-12"></span>
                                    <span class="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform skew-x-12"></span>
                        ...
                        <img src="image/cr3.png" alt="Slide 1" class="w-screen h-[628px] object-cover border border-solid border-white">
                    </div>
                    ...
                    <div class="carousel-item relative flex items-center">
                        <div class="absolute inset-0 flex items-center justify-center text-accent p-4 bg-slate-500 bg-opacity-60">
                            <div class="text-center">
                                ...
                                <h2 class="text-4xl font-bold text-emerald-200 mb-4 animate-bounce animate-duration-10 animate-delay-5 mt-10">
                                    Over 20 Years of Experience</h2>
                            </div>
                        </div>
                        <img src="image/carousel1.jpg" alt="Slide 2" class="w-screen h-[628px] object-cover border border-solid border-white">
                    </div>

                    <div class="carousel-item relative">
                        <div class="absolute inset-0 flex items-center justify-center text-accent p-4 bg-slate-500 bg-opacity-60">
                            <div class="text-center">
                                <h2 class="text-4xl font-bold text-emerald-200 mb-4 animate-bounce animate-duration-10 animate-delay-5">
                        ...
                        <img src="image/carousel2.jpg" alt="Slide 3" class="w-screen h-[628px] object-cover border border-solid border-white">
                    </div>
                </div>
        ...
        <div class="p-10 max-w-screen-lg mx-auto">
            <div class="text-center mb-4">
                <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
                    Executive<span class="text-emerald-800"> Team</span>
                </h3>
            </div>
            <div class="sm:grid grid-cols-2 gap-6 my-10">
                ...
                <div class="max-w-sm w-full lg:max-w-full lg:flex mx-auto my-10">
                    <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
                        <img src="image/chairman.png" class="block h-full w-full rounded-lg object-cover object-center">
                    </div>
                    <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4">
                        <div class="">
                            <p class="text-gray-900 font-bold text-xl mb-2 hover:text-indigo-600 transition duration-500 ease-in-out">
                                Kshitij Dhungana</p>
                            <p class="text-sm text-gray-600">
                                <span class="text-emerald-800 font-bold">CHAIRMAN</span>
                            </p>
                            <p class="text-gray-500 text-[12px] text-base mt-4">Dear Guests,
                                I am delighted to welcome you as a chairman of <span class="text-emerald-800 font-bold">ALZAHRA
                                    HUMAN RESOURCE</span>
                            </p>
  ...
  C93.282,101.457,89.661,116.261,93.282,126.483z"></path>
                ...
                <div class="max-w-sm w-full lg:max-w-full lg:flex mx-auto my-10">
                    <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
                        <img src="image/ceo.jpg" class="block h-full w-full rounded-lg object-cover object-center">
                    ...
                    <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4">
                        <div class="">
                            ...
                            <p class="text-gray-500 text-[12px] text-base mt-4">Dear Guests,
                                I am delighted to welcome you as a CEO of <span class="text-emerald-800 font-bold">ALZAHRA
                                    HUMAN RESOURCE</span>
                            </p>
  ...
  C93.282,101.457,89.661,116.261,93.282,126.483z"></path>
    ...
    <section>
        <h1 class="text-center text-emerald-800 font-bold text-[35px] mb-6 bg-emerald-100 lg:mt-5">Our Prestigious
            Clients</h1>
        <div class="owl-carousel owl-theme bg-grey lg:py-12">
            ...
            <div class="flex item-center w-full h-[160px]">
                <img src="{{ $company->getFirstMediaUrl() }}" class="block max-h-[80px] max-w-full rounded-lg object-cover object-center" alt="#">
            </div>
            @endforeach
            @endforeach

        </div>
        <a class="text-center text-emerald-800" href="/clients" wire:navigate>View all clients</a>
    </section>
            ...
            <div class="container mx-auto">
                <div class="services__top items-center xl:mb-[10px]">
                    ...
                    <div class="your-jobs-container flex space-x-80">
                        @foreach ($jobs as $job)
                        <div class="job-info">
                            <p class="job-title">Job title: <span class="text-accent">{{ $job->job_title }}</span>
                            </p>
