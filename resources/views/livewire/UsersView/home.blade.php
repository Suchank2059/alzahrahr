                        ...
                        <div class="absolute inset-0 flex items-center justify-center text-accent p-4">
                            <div class="text-center">
                                ...
                                <a href="#_" class="relative px-5 py-2 mr-4 font-medium text-white group">
                                    ...
                                    <span
                                        class="relative animate-bounce animate-duration-[10ms] animate-delay-[5ms]">Button
                                        Text</span>
                                </a>
        ...
        <div class="container flex justify-center items-center px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                    ...
                    <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">mlakdgnl'asdfa asdf;na;ndf f
                        asdnf'asdkf k dsaknf;kasdfj fjndsakjfo asdfjiasdjf asfdja sdfjasiodjf aisdhfasd fhasdfhas
                        dfhaspdfhasdfashdf</p>
