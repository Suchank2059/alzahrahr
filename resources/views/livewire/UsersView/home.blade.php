            ...
            <div class="carousel" id="myCarousel">
                <div class="carousel-inner ">
                    <div class="carousel-item relative flex items-center">
                        <div class="absolute inset-0 flex items-center justify-center text-accent p-4">
                            <div class="text-center">
                                <h2 class="text-4xl font-bold text-emerald-200 animate-bounce animate-duration-[10ms] animate-delay-[5ms] mb-4">
                                ...
                                <button class="relative px-5 py-2 mr-4 font-medium text-white group">
                                    ...
                                    <span class="relative animate-bounce animate-duration-[10ms] animate-delay-[5ms]">Download
                    ...
                    <div class="carousel-item relative flex items-center">
                        <div class="absolute inset-0 flex items-center justify-center text-accent p-4">
                            <div class="text-center">
                                ...
                                <h2 class="text-4xl font-bold text-emerald-200 mb-4 animate-bounce animate-duration-[10ms] animate-delay-[5ms] mt-10">
                    ...
                    <div class="carousel-item relative">
                        <div class="absolute inset-0 flex items-center justify-center text-accent p-4">
                            <div class="text-center">
                                <h2 class="text-4xl font-bold text-emerald-200 mb-4 animate-bounce animate-duration-[10ms] animate-delay-[5ms]">
                ...
                <button class="absolute top-1/2 transform -translate-y-1/2 left-2 carousel-control prev text-accent hover:text-emerald-700" onclick="prevSlide()">&#10094;</button>
                <button class="absolute top-1/2 transform -translate-y-1/2 right-2 carousel-control next text-accent hover:text-emerald-700" onclick="nextSlide()">&#10095;</button>
            </div>
        </div>
