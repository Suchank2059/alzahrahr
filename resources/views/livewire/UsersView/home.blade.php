<div>
            ...
            <div class="carousel" id="myCarousel">
                <div class="carousel-inner">
                    <div class="carousel-item relative flex items-center">
                        <div
                            class="absolute inset-0 flex items-center justify-center text-accent p-4 bg-slate-500 bg-opacity-60">
                            <div class="text-center">
                                <h2
                                    class="text-4xl font-bold text-emerald-200 animate-bounce animate-duration-10 animate-delay-5 mb-4">
                                    Alzahra Human Resource Consultancy Welcomes You</h2>
                                <button
                                    class="relative px-5 py-2 mr-4 font-medium text-white group bg-purple-700 hover:bg-purple-500">
                                    <span
                                        class="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform translate-x-0 -skew-x-12"></span>
                                    <span
                                        class="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform skew-x-12"></span>
                                    <span
                                    ...
                                    <span class="relative animate-bounce animate-duration-10 animate-delay-5">Download
                                        Company Profile</span>
                                </button>
                            </div>
                        </div>
                        <img src="image/cr3.png" alt="Slide 1"
                            class="w-screen h-[628px] object-cover border border-solid border-white">
                    </div>
                    ...
                    <div class="carousel-item relative flex items-center">
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <h2
                                    class="text-4xl font-bold text-emerald-200 mb-4 animate-bounce animate-duration-10 animate-delay-5 mt-10">
                                    Over 20 Years of Experience</h2>
                            </div>
                        </div>
                        <img src="image/carousel1.jpg" alt="Slide 2"
                            class="w-screen h-[628px] object-cover border border-solid border-white">
                    </div>
                    ...
                    <div class="carousel-item relative">
                        <div
                            ...
                            <div class="text-center">
                                <h2
                                    class="text-4xl font-bold text-emerald-200 mb-4 animate-bounce animate-duration-10 animate-delay-5">
                        ...
                        <img src="image/carousel2.jpg" alt="Slide 3"
                            class="w-screen h-[628px] object-cover border border-solid border-white">
                    </div>
                </div>
    ...
    <section class="bg-white dark:bg-gray-900" style="background-image:url('image/bg.jpg')">
        <div class="p-10 max-w-screen-lg mx-auto">
            ...
            <div class="sm:grid grid-cols-2 gap-6 my-10">
                ...
                <div class="max-w-sm w-full lg:max-w-full lg:flex mx-auto my-10">
                    <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('https://images.pexels.com/photos/3785084/pexels-photo-3785084.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500')" title="Woman holding a mug">
                    </div>
                    <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4">
                        <div class="">
                            <a href="#" class="text-gray-900 font-bold text-xl mb-2 hover:text-indigo-600 transition duration-500 ease-in-out">Yahya
                                R. Makarim</a>
                            <p class="text-sm text-gray-600">
                                CEO &amp; President
                            </p>
                            <p class="text-gray-500 text-base mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            </p>
		...
		C93.282,101.457,89.661,116.261,93.282,126.483z"></path>
                ...
                <div class="max-w-sm w-full lg:max-w-full lg:flex mx-auto my-10">
                    <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500')" title="Woman holding a mug">
                    </div>
                    <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4">
                        <div class="">
                            <a href="#" class="text-gray-900 font-bold text-xl mb-2 hover:text-indigo-600 transition duration-500 ease-in-out">Zakir
                                Hussain Rezai</a>
                            <p class="text-sm text-gray-600">
                                VueJS Developer
                            </p>
    ...
    <section>
        ...
        <main class="grid  w-full place-items-center">
            <div class="grid w-[40rem] grid-cols-6 gap-2 rounded-xl bg-gray-200 p-2">
                <div>
                    <input type="radio" name="option" id="1" value="1" class="peer hidden" checked />
                    <label for="1" class="block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">Europe</label>
                </div>

                <div>
                    <input type="radio" name="option" id="2" value="2" class="peer hidden" />
                    <label for="2" class="block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">kuwait</label>
                </div>

                <div>
                    <input type="radio" name="option" id="3" value="3" class="peer hidden" />
                    <label for="3" class="block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">UAE</label>
                </div>

                <div>
                    <input type="radio" name="option" id="4" value="3" class="peer hidden" />
                    <label for="4" class="block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">Qatar</label>
                </div>
                <div>
                    <input type="radio" name="option" id="5" value="3" class="peer hidden" />
                    <label for="5" class="block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">Baharain</label>
                </div>
                <div>
                    <input type="radio" name="option" id="6" value="3" class="peer hidden" />
                    <label for="6" class="block cursor-pointer select-none rounded-xl p-2 text-center peer-checked:bg-blue-500 peer-checked:font-bold peer-checked:text-white">Malaysia</label>
                </div>
            </div>
        </main>
            ...
            <div class="container mx-auto">
                <div class="services__top items-center xl:mb-[60px]">
                    ...
                    <div class="your-jobs-container flex space-x-80">
                        @foreach ($jobs as $job)
                        <div class="job-info">
                            <p class="job-title">Job title: <span class="text-accent">{{ $job->job_title }}</span></p>
                            <p class="vacancies">Vacancies: <span class="text-accent">{{ $job->male_required + $job->female_required }}</span>
                            </p>
                        </div>
                        @endforeach
                    </div>
    ...
    <section class="service sm:hidden md:block items-center justify-center w-full" style="background-image: url('image/desert.png')">
        ...
        <div class="containers flex">
            <div class="card relative max-w-300 h-215 bg-white m-30 mx-10 p-20 pb-15 flex flex-col shadow-md transition-transform duration-300 ease-in-out rounded-15 hover:h-[320px]">
                <div class="image relative w-260 h-260 top-neg-40 left-8 shadow-md z-10">
                    <img class="max-w-full rounded-15" href="#" src=https://i.pinimg.com/originals/a4/7b/a5/a47ba59b4a353e0928ef0551ca44f980.jpg>
                </div>
                <div class="content relative top-neg-140 pt-32 text-center text-black visibility-hidden opacity-0 transition-opacity duration-300 ease-in-out">
