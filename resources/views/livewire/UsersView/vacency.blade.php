                ...
                <div class="bg-white rounded-3xl shadow-custom2 w-full p-4">
                    <div class="w-full">
                                ...
                                <li class="py-2 border-t-2 border-dotted">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col">
                                            <span class="text-emerald-800 text-sm">{{ $job->job_title }}</span>
                                            <p class="fa fa-map-marker font-bold text-md text-emerald-800 mt-3">
                        ...
                        <div class="flex gap-x-6">
                            <p class="text-emerald-700 mt-8 text-2xl font-bold">
                                Required Total Employees:
                                <span class="text-secondary">
                                    {{ $job->male_required + $job->female_required }} (M:{{ $job->male_required }}
                                    <span>F:{{ $job->female_required }}</span>)
                                </span>
                            </p>
                            <p class="text-emerald-700 mt-8 text-2xl font-bold">
                                Salary:
